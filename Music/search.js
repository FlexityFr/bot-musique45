...
module.exports = {
  name: "search",
  description: "Recherchez et sélectionnez des vidéos à lire",
  aliases: ["find"],
  cooldown: 3,
  edesc: `Tapez cette commande pour trouver les 5 premiers résultats pour votre chanson!\nUsage: ${PREFIX}search <TITEL | URL>`,
...
async execute(message,args,client) {
    ...
    .setAuthor("Recherche...", "https://cdn.discordapp.com/emojis/757632044632375386.gif?v=1")
    .setColor("#f300e5")
    //define the Result Embed
    let resultsEmbed = new MessageEmbed()
      .setTitle("✅ résultats pour: ")
      .setDescription(`\`${search}\``)
      .setColor("#f300e5")
      .setFooter("Réponse avec votre numéro préféré", client.user.displayAvatarURL() )
    ...
    try {
      ...
      if(response === "error"){
        //send error message
        attentionembed(message,"Veuillez utiliser un bon emoji!");
