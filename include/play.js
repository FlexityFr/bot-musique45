  ...
  let thumb;
    ...
    try {
      const newsong = new MessageEmbed()
        ...
        .addField("Durée:", `\`${song.duration} Minutes\``, true)
    ...
    collector.on("collect", async (reaction, user) => {
      ...
      switch (reaction.emoji.name) {
        ...
        case "⏭":
          ...
          const skipembed = new MessageEmbed().setColor("#c219d8").setAuthor(`${user.username} a sauté la chanson.`, "https://cdn.discordapp.com/attachments/748633941912584333/753201474691137647/next.png")
        ...
        case "📑":
          ...
          .setAuthor("Recherche...", "https://cdn.discordapp.com/emojis/757632044632375386.gif?v=1").setFooter("Lyrics")
          .setColor("#c219d8")
        ...
        case "⏯":
          ...
          if (queue.playing) {
            ...
            const pausemebed = new MessageEmbed().setColor("#c219d8")
              .setAuthor(`${user.username} a mis la musique en pause.`, "https://cdn.discordapp.com/emojis/769912238236106793.png")
            queue.textChannel.send(pausemebed).catch(console.error);
          } else {
            queue.playing = !queue.playing;
            queue.connection.dispatcher.resume();
            const playembed = new MessageEmbed().setColor("#c219d8")
              .setAuthor(`${user.username} repris la musique!`, "https://cdn.discordapp.com/emojis/769912238236106793.png")
        ...
        case "🔄":
          ...
          const loopembed = new MessageEmbed().setColor("#c219d8")
            .setAuthor(`Loop is now ${queue.loop ? " activé" : " désactivé"}`, "https://cdn.discordapp.com/emojis/769913064194834511.png")
        ...
        case "⏹":
          ...
          if (!canModifyQueue(member)) return;
          queue.songs = [];
          const stopembed = new MessageEmbed().setColor("#c219d8").setAuthor(`${user.username} arrêté la musique!`, "https://cdn.discordapp.com/emojis/769915194066862080.png")
